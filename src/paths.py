MAP_DATA_STATE_REGIONS_FOLDER = "map_data/state_regions"
...
# Input
STATES_DATA_INPUT = INPUT_FOLDER + "/state_data.yml"
SPLIT_STATES_INPUT = INPUT_FOLDER + "/split_states.json"
STATES_INPUT = INPUT_FOLDER + "/states.json"
STATES_DATA_YML_INPUT = INPUT_FOLDER + "/state_data.yml"
# Output
STATE_HISTORY_OUTPUT = OUTPUT_FOLDER + "/state_history.txt"
POPS_OUTPUT = OUTPUT_FOLDER + "/pops.txt"
BUILDINGS_OUTPUT = OUTPUT_FOLDER + "/buildings.txt"
STATES_MAP_DATA_OUTPUT = OUTPUT_FOLDER + "/00_states.txt"
